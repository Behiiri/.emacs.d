...
(let ((beam-font         "Liberation Mono")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((t (:foreground, beam-bright-green))))
   ...
   `(font-lock-type-face ((t (:foreground, beam-fg))))
   `(font-lock-doc-face ((t (:foreground, beam-grey))))
   `(font-lock-variable-name-face ((t (:foreground, beam-fg))))
   ...
   `(diff-added ((t (:background, beam-black :foreground, beam-green))))
   `(diff-changed ((t (:background, beam-black :foreground, beam-bright-green))))
   `(diff-removed ((t (:background, beam-black :foreground, beam-grey))))
   ...
   `(isearch ((t (:foreground, beam-light-green :background, beam-dark-green ))))
